...
@objc public protocol LineGraphDelegate {
    
    optional func didSelectDataPoint(x: CGFloat, yValues: Array<CGFloat>)
...
public class LineGraph: UIView {
    ...
    */
    func handleTouchEvents(touches: NSSet!, event: UIEvent!) {
        ...
        self.delegate?.didSelectDataPoint!(CGFloat(closestXValueIndex), yValues: yValues)
    }
